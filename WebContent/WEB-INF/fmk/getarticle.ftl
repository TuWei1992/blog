		...
		<div class="top-bar">
			<div class="frame">
				<div class="frame-inside">
					...
					<div class="menu-header-container"><ul id="menu-header" class="nav"><li id="menu-item-109" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-109"><a href="index.html">Home</a></li>
...
<li id="menu-item-85" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-85"><a href="http://#">Drop Menu</a>
<ul class="sub-menu">
...
<li id="menu-item-218" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-218"><a href="contact.html">Contact</a></li>
					...
					<div id="social-strip-icons">
								...
								<a href="#" title="facebook"><img src="images/icon-facebook-color.png" alt="facebook" class="b" /></a>
													...
													<div class="fadehover">
								<a href="http://www.flickr.com/photos/64104492@N02/" title="flickr"><img src="images/icon-flickr.png" alt="flickr" class="a" /></a>
								<a href="http://www.flickr.com/photos/64104492@N02/" title="flickr"><img src="images/icon-flickr-color.png" alt="flickr" class="b" /></a>
							</div>
		...
		<div style="clear:both;"></div>		<div id="main" class="clearfix">
			...
			<!-- grab the sidebar -->
				...
				<div id="sidebar">				
					...
					<!-- grab the logo -->
							            	<h1>
							<a href="#"><img class="logo" src="images/assets/dispatch3.png" alt="Bugatti Type 35B" /></a>
						</h1>
		...
		<div class="flickr">
			...
			<div id="content" class="filter-posts">
				...
				<div data-id="post-159" data-type="articles" class="post-159 articles post clearfix project">
					<div class="box">
						<div class="shadow clearfix">
							<div class="frame">
								<h2 class="entry-title"><a href="#" title="Why So Serious?">${obj.title}</a></h2>
						...
						<div class="bar" >
							<div class="bar-frame clearfix">
								...
								<div class="categories">
									...
									<p><a href="#" title="View all posts in Articles" rel="category">${obj.type}</a></p>
								</div>
								<div class="comments">
							  	...
							  	<div class="tags">
							  		...
							  		<p><a href="#" rel="tag">${obj.tags}</a></p>
							  	</div>							  	
							  										<div class="next-post">
										<strong class="title">NEXT POST</strong><span><a href="#" rel="next">Parallelostory</a></span>									</div>
									
									<div class="prev-post">
										<strong class="title">PREVIOUS POST</strong><span><a href="#" rel="prev">Bugatti Type 35B</a></span>									</div>
															</div><!-- bar frame -->
						</div><!-- bar -->
					</div><!-- box -->
				</div><!--writing post-->
...
<input type='hidden' name='comment_parent' id='comment_parent' value='0' />
							...
							</div><!--content-->			<div class="push"></div>
		</div><!--main-->
