...
<#----头部------------------------------------->
 ...
 <form action="puttags" method="post" id="msform" >
<strong><i style="background:#428BD1;"></i>添加标签</strong></br>
   <input name="tags" type="text" />
   
   <input type="Submit" name="next" class="action-button" value="提交" />
   </form>
 ...
 <form action="puttype" method="post" id="msform" >
 <strong><i style="background:#428BD1;"></i>添加类型</strong></br>
...
<form id="blog-form"  action="postarticle" method="post" enctype="multipart/form-data" >
...
<div class="write-blog">
	<div class="section">
		...
		<div class="blog-title">
			<input type="text" class="b-input c-input f-input" size="80" maxLength="50" name="title" placeholder="博客标题"/>
	...
	<div class="section">
		<strong><i style="background:#40aa53;"></i>博客摘要</strong>
         <textarea class="m-input d-input" name="abstracts" id="abstracts" > </textarea>
	</div>
		...
		<strong><i style="background:#40aa53;"></i>上传图片</strong><br><br>
     	   ...
     	   <div class="section">
		     ...
		     <textarea class="m-input d-input" name="content1" id="content_1"   > </textarea>
...
<script type="text/javascript">
	...
	var Blog = {
		...
		switch_editor : function(type){
        	...
        	jQuery.post('/action/blog/set_blog_editor?type=' + type, function(){
        		Blog.warn = false;
        		location.reload();
        	});
		},
		stash:function(){
			...
			jQuery("#blog-form").ajaxSubmit({
        		dataType:'json',
        		type:'POST',
        		url:'/action/blog/save?save_as_draft=1',
